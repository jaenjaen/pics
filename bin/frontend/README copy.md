...
```
OS : Windows 10(develop)
IDE : Visual Stuid Code, Spring Tool Suite 3, Jupyter NoteBook
DB : MySQL
Language : Java 1.8 , JavaScript
Browser : Chrome / 아래 참고
Framework : Spring, Vue, JPA, Flask
Etc : <<<<무엇을 써야할까>>>>
```
...
| person       | 주 역할                               | 기타                                   |
| ------------ | ------------------------------------- | -------------------------------------- |
| 이재은(팀장) | 로그인, 마이페이지, 리뷰              | 팀장, github, 일정/업무 관리           |
| 강제영       | 공간 검색, 공간 리스트,               | 서기                                   |
| 김연희       | 공간 등록, 문의 챗                    |                                        |
| 임채은       | 상세페이지, 예약                      |                                        |
| 박찬영       | 메인페이지, 헤더, 푸터                |                                        |
...
- **촬영공간**을 찾는 기업과 개인에게 더 나은 인프라 제공

...
def tag_data():
    ...
    # 자연어 처리
#     from model import nlp_model
#     CoreTagData1=getCoreTags1(dataset) # tag data1
#     CoreTagData2=getCoreTags2(dataset) # tag data2
...
#     stuId=1
    ...
    # Counting Words
#     from model import count_tag_model
#     count_tag_model.tagCount(stuId,dataset)

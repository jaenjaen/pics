  ...
  methods: {
    ...
    selectDay(day) {
      ...
      if (day == "all") {
        ...
        if (thisCheck.checked) {
          ...
          //요일 선택해제시 해당 요일 시간표 전체 체크 해제 및 숨김
    ...
    selectTime(day) {
      ...
      for (let i = 0; i < temp_list.length; i++) {
        if (this.timePerDay[i] == 0) {
          //선택하지 않은 상태
          this.timePerDay[i] = 1;
        }
        if (this.timePerDay[i] == 1) {
          //선택한 상태
          this.timePerDay[i] = 0;
        }
      }
    ...
    addStudio() {
      ...
      if (this.addressResult.address == "") {
        ...
        this.studio.studioFilter.address =
          this.addressResult.address + " " + this.addressDetail;
      }

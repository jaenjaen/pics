...
export default {
    ...
    methods: {
        ...
        getRecentChatByStuIdAndCustName(stuId, custName) {
            axios
                .get('http://localhost:7777/chat/recent/com/' + company.comId + '/' + stuId + '/' + custName)
                .then(response => {
                    if (response.data != -1) {
        ...
        getRecentChatByCustName(custName) {
            axios
                .get('http://localhost:7777/chat/recent/com/' + company.comId + '/' + custName)
                .then(response => {
                    if (response.data != -1) {
        ...
        updateReadCheck() {
            ...
            axios.put('http://localhost:7777/chat/prev/' + this.chat.stuId + '/' + this.chat.custId + '/' + other)
                .then(() => {
        ...
        getPrevAllChat() {
            axios
                .get('http://localhost:7777/chat/prev/' + this.chat.stuId + '/' + this.chat.custId)
                .then(response => {
                    if (response.data != -1) {

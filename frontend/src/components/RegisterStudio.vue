          ...
          <div class="col-75 uploadTotal">
            <div class="uploadArea">
              <input
                type="file"
                id="mainFile1"
                @change="handleImgFileSelect('mainFile1', 'mainImg1', $event)"
                style="display: none;"
              />
              <img
                src="../assets/img/upload/preview.png"
                class="uploadImg"
                id="mainImg1"
                onclick='document.getElementById("mainFile1").click()'
              />
            </div>
            <div class="uploadArea">
              <input
                type="file"
                id="mainFile2"
                @change="handleImgFileSelect('mainFile2', 'mainImg2', $event)"
                style="display: none;"
              />
              <img
                src="../assets/img/upload/preview.png"
                class="uploadImg"
                id="mainImg2"
                onclick='document.getElementById("mainFile2").click()'
              />
            </div>
            <div class="uploadArea">
              <input
                type="file"
                id="mainFile3"
                @change="handleImgFileSelect('mainFile3', 'mainImg3', $event)"
                style="display: none;"
              />
              <img
                src="../assets/img/upload/preview.png"
                class="uploadImg"
                id="mainImg3"
                onclick='document.getElementById("mainFile3").click()'
              />
            </div>
            <div class="uploadArea">
              <input
                type="file"
                id="mainFile4"
                @change="handleImgFileSelect('mainFile4', 'mainImg4', $event)"
                style="display: none;"
              />
              <img
                src="../assets/img/upload/preview.png"
                class="uploadImg"
                id="mainImg4"
                onclick='document.getElementById("mainFile4").click()'
              />
            </div>
            <div class="uploadArea">
              <input
                type="file"
                id="mainFile5"
                @change="handleImgFileSelect('mainFile5', 'mainImg5', $event)"
                style="display: none;"
              />
              <img
                src="../assets/img/upload/preview.png"
                class="uploadImg"
                id="mainImg5"
                onclick='document.getElementById("mainFile5").click()'
              />
            </div>
            <div class="uploadArea">
              <input
                type="file"
                id="mainFile6"
                @change="handleImgFileSelect('mainFile6', 'mainImg6', $event)"
                style="display: none;"
              />
              <img
                src="../assets/img/upload/preview.png"
                class="uploadImg"
                id="mainImg6"
                onclick='document.getElementById("mainFile6").click()'
              />
            </div>
            <div class="uploadArea">
              <input
                type="file"
                id="mainFile7"
                @change="handleImgFileSelect('mainFile7', 'mainImg7', $event)"
                style="display: none;"
              />
              <img
                src="../assets/img/upload/preview.png"
                class="uploadImg"
                id="mainImg7"
                onclick='document.getElementById("mainFile7").click()'
              />
            </div>
            <div class="uploadArea">
              <input
                type="file"
                id="mainFile8"
                @change="handleImgFileSelect('mainFile8', 'mainImg8', $event)"
                style="display: none;"
              />
              <img
                src="../assets/img/upload/preview.png"
                class="uploadImg"
                id="mainImg8"
                onclick='document.getElementById("mainFile8").click()'
              />
            </div>
            <div class="uploadArea">
              <input
                type="file"
                id="mainFile9"
                @change="handleImgFileSelect('mainFile9', 'mainImg9', $event)"
                style="display: none;"
              />
              <img
                src="../assets/img/upload/preview.png"
                class="uploadImg"
                id="mainImg9"
                onclick='document.getElementById("mainFile9").click()'
              />
            </div>
            <div class="uploadArea">
              <input
                type="file"
                id="mainFile10"
                @change="handleImgFileSelect('mainFile10', 'mainImg10', $event)"
                style="display: none;"
              />
              <img
                src="../assets/img/upload/preview.png"
                class="uploadImg"
                id="mainImg10"
                onclick='document.getElementById("mainFile10").click()'
              />
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-75">
            ...
            <button
              type="button"
              id="searchAddr"
              @click="controlAddress('showAddress')"
            >
              찾기
            </button>
            <button
              type="button"
              id="closeAddr"
              @click="controlAddress('hideAddress')"
            >
              닫기
            </button>
            <p>
          ...
          <div class="col-75 uploadTotal">
            <div class="uploadArea">
              <input
                type="file"
                id="cadFile"
                @change="handleImgFileSelect('cadFile', 'cadImg', $event)"
                style="display: none;"
              />
              <img
                src="../assets/img/upload/preview.png"
          ...
          <table class="daySelect" id="monTd">
            ...
            <tr>
              <td>
                ...
                >
                  <option
                    v-for="(time, index) in week.mon"
                    :key="index"
                    style="border: 2px solid #46E8CC"
                  >
                    {{ index }}시-{{ index + 1 }}시
                  </option>
                </select>
          ...
          <table class="daySelect" id="tueTd">
            ...
            <tr>
              <td>
                ...
                >
                  <option
                    v-for="(time, index) in week.tue"
                    :key="index"
                    style="border: 2px solid #49E1F2"
                  >
                    {{ index }}시-{{ index + 1 }}시
                  </option>
                </select>
          ...
          <table class="daySelect" id="wedTd">
            ...
            <tr>
              <td>
                ...
                >
                  <option
                    v-for="(time, index) in week.wed"
                    :key="index"
                    style="border: 2px solid #4DA6DB"
                  >
                    {{ index }}시-{{ index + 1 }}시
                  </option>
                </select>
            ...
            <tr>
              <td>
                <select multiple size="24" id="thuTime" name="dayTime">
                  <option
                    v-for="(time, index) in week.thu"
                    :key="index"
                    style="border: 2px solid #4987F2"
                  >
                    {{ index }}시-{{ index + 1 }}시
                  </option>
                </select>
            ...
            <tr>
              <td>
                <select multiple size="24" id="friTime" name="dayTime">
                  <option
                    v-for="(time, index) in week.fri"
                    :key="index"
                    style="border: 2px solid #4657E8"
                  >
                    {{ index }}시-{{ index + 1 }}시
                  </option>
                </select>
            ...
            <tr>
              <td>
                <select multiple size="24" id="satTime" name="dayTime">
                  <option
                    v-for="(time, index) in week.sat"
                    :key="index"
                    style="border: 2px solid #A244F2"
                  >
                    {{ index }}시-{{ index + 1 }}시
                  </option>
                </select>
            ...
            <tr>
              <td>
                <select multiple size="24" id="sunTime" name="dayTime">
                  <option
                    v-for="(time, index) in week.sun"
                    :key="index"
                    style="border: 2px solid #C941E8"
                  >
                    {{ index }}시-{{ index + 1 }}시
                  </option>
                </select>
          ...
          <div class="col-75 uploadTotal">
            <div class="uploadArea">
              <input
                type="file"
                id="portFile1"
                @change="handleImgFileSelect('portFile1', 'portImg1', $event)"
                style="display: none;"
              />
              <img
                src="../assets/img/upload/port.png"
                class="uploadImg"
                id="portImg1"
                onclick='document.getElementById("portFile1").click()'
              />
            </div>
            <div class="uploadArea">
              <input
                type="file"
                id="portFile2"
                @change="handleImgFileSelect('portFile2', 'portImg2', $event)"
                style="display: none;"
              />
              <img
                src="../assets/img/upload/port.png"
                class="uploadImg"
                id="portImg2"
                onclick='document.getElementById("portFile2").click()'
              />
            </div>
            <div class="uploadArea">
              <input
                type="file"
                id="portFile3"
                @change="handleImgFileSelect('portFile3', 'portImg3', $event)"
                style="display: none;"
              />
              <img
                src="../assets/img/upload/port.png"
                class="uploadImg"
                id="portImg3"
                onclick='document.getElementById("portFile3").click()'
              />
            </div>
            <div class="uploadArea">
              <input
                type="file"
                id="portFile4"
                @change="handleImgFileSelect('portFile4', 'portImg4', $event)"
                style="display: none;"
              />
              <img
                src="../assets/img/upload/port.png"
                class="uploadImg"
                id="portImg4"
                onclick='document.getElementById("portFile4").click()'
              />
            </div>
          </div>
        </div>

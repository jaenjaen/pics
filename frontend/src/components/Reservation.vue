          ...
          <form method="post" @submit.prevent="addReserve">
            ...
            <!-- 시간 -->
              <div>
                [시작 시간]
                <span>
                <select id="start_time" v-model="start_time" required style="width:50%">
            ...
            <div>
              <table width="70%" align="center">              
                <tr>
                  <td><button id="deletePeopleBtn" @click.prevent="deletePeople()" style="display:inline">-</button></td>
                  <td><input type="text"
                  id="totalPeople" 
                  name="totalPeople" 
                  width="0.2em"
                  ...
                  ></td>
                  <td><button id="addPeopleBtn" @click.prevent="addPeople()" style="display:inline">+</button></td>
                </tr>
              </table>
            </div>
              ...
              <div>
                ...
                <table  align="center">
                  ...
                  <tr align="right">
                    ...
                    <td><span id="total_price">{{totalPriceCalculate|currency}} 원</span></td>
                  </tr >
                 </table>
               <div>

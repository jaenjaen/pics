...
class CalendarPicker {
    ...
    _insertHeaderIntoCalendarWrapper = () => {
        this.calendarHeaderTitle.textContent = `${this.year}년 ${this.listOfAllMonthsAsText[this.month]}`;
    ...
    _insertNavigationButtons = () => {
        ...
        const arrowSvg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.83 77.29"><defs><style>.cls-1{fill:#33a3dc;}</style></defs><title>자산 2</title><g id="레이어_2" data-name="레이어 2"><g id="Layer_2" data-name="Layer 2"><rect class="cls-1" x="8.35" width="6.13" height="68.81"/><polygon class="cls-1" points="0 60.33 11.42 77.29 22.83 60.33 0 60.33"/></g></g></svg>';

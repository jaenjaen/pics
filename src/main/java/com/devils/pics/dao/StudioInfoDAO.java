...
public interface StudioInfoDAO {
	...
	public Studio getStudioByNameAndComId(Studio studio); //name, comId로 Studio를 찾아옴
	public Studio getStudioByAddrAndComId(Studio studio); //addr, comId로 Studio를 찾아옴
